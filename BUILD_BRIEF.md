...
- `01-dashboard.md` -> `app/(app)/dashboard/page.tsx`
- `02-sales-board.md` -> `app/(app)/sales/page.tsx`
- `03-quote-builder.md` -> `app/(app)/quote/page.tsx` and `app/(app)/quote/[quoteId]/page.tsx`
- `04-contacts.md` -> `app/(app)/contacts/page.tsx`
- `05-compliance.md` -> `app/(app)/compliance/page.tsx`
- `06-order-board.md` -> `app/(app)/orders/page.tsx`
- `07-operator-card.md` -> `app/(app)/job-card/page.tsx`
- `08-dispatch-checklist.md` -> `app/(app)/dispatch/page.tsx`
- `09-invoice-readiness.md` -> `app/(app)/accounting/page.tsx`
- `10-record-journey.md` -> `app/(app)/records/[recordId]/page.tsx`
- `11-command-palette.md` -> `components/shell/CommandPalette.tsx` plus shell trigger wiring only when explicitly coordinated
- `12-approvals-inbox.md` -> `app/(app)/approvals/page.tsx`
- `13-integrations-hub.md` -> `app/(app)/integrations/page.tsx`
- `14-settings-admin.md` -> `app/(app)/settings/page.tsx`
...
- `app/layout.tsx`, `app/(app)/layout.tsx`, `app/page.tsx`, `app/globals.css`
