/*  Contacts/customer-management screen including validation,
    GSTIN handling, customer persistence, filtering, role behaviour,
    and integrations-related customer actions. */
